...
#line 24 "..\\Driver\\src\\led.c"
#line 25 "..\\Driver\\src\\led.c"
#line 1 "..\\Driver\\inc\\led.h"
...
void Bsp_LedInit(void)
{
	...
	Gpio_StInit.GPIO_Pin = ((uint16_t)0x0100);				 
	Gpio_StInit.GPIO_Mode = GPIO_Mode_Out_PP; 		 
	Gpio_StInit.GPIO_Speed = GPIO_Speed_50MHz;		 
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), &Gpio_StInit);					 	

	Gpio_StInit.GPIO_Pin = ((uint16_t)0x0004);	    		 
	Gpio_StInit.GPIO_Mode = GPIO_Mode_Out_PP; 		 
	Gpio_StInit.GPIO_Speed = GPIO_Speed_50MHz;		
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400)), &Gpio_StInit);	  				
