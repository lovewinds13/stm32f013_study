...
static void uart_gpio_init(uint8_t uart_chl)
{
    ...
    if (uart_chl == 1)
    {
		...
		gpio_config_init.GPIO_Pin 	= ((uint16_t)0x0200); 
		...
		gpio_config_init.GPIO_Pin 	= ((uint16_t)0x0400);
    ...
    else if (uart_chl == 2)
    {
		...
		gpio_config_init.GPIO_Pin = ((uint16_t)0x0008);
		gpio_config_init.GPIO_Mode = GPIO_Mode_IN_FLOATING;
		GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), &gpio_config_init);
    }
    else if (uart_chl == 3)
    {
		...
		gpio_config_init.GPIO_Speed = GPIO_Speed_50MHz;
		gpio_config_init.GPIO_Mode = GPIO_Mode_AF_PP;	
		GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), &gpio_config_init);

		gpio_config_init.GPIO_Pin = ((uint16_t)0x0800);
		gpio_config_init.GPIO_Mode = GPIO_Mode_IN_FLOATING;
		GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), &gpio_config_init);
    }
    else if (uart_chl == 4)
     ...
     else if (uart_chl == 5)
    {
		...
		gpio_config_init.GPIO_Pin = ((uint16_t)0x1000); 
		gpio_config_init.GPIO_Speed = GPIO_Speed_50MHz;
		gpio_config_init.GPIO_Mode = GPIO_Mode_AF_PP;	
		GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), &gpio_config_init);	
		...
		gpio_config_init.GPIO_Pin = ((uint16_t)0x0004);	
		gpio_config_init.GPIO_Mode = GPIO_Mode_IN_FLOATING;	
		GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400)), &gpio_config_init);	
    }
    else 
    {
...
static void uart_config(uint8_t uart_chl, uint32_t uart_bound)
{
    ...
    if (uart_chl == 1)
    {
		...
		uart_config_init.USART_BaudRate              = uart_bound;	
		uart_config_init.USART_WordLength            = ((uint16_t)0x0000);	
		uart_config_init.USART_StopBits              = ((uint16_t)0x0000);	
		uart_config_init.USART_Parity                = ((uint16_t)0x0000);	
		uart_config_init.USART_HardwareFlowControl   = ((uint16_t)0x0000);	
		uart_config_init.USART_Mode                  = ((uint16_t)0x0004) | ((uint16_t)0x0008);	

		USART_Init(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), &uart_config_init); 
    ...
    else if (uart_chl == 2)
    {
		...
		USART_Init(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), &uart_config_init); 
		
		USART_Cmd(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), ENABLE); 		
    }
    else if (uart_chl == 3)
    {
		RCC_APB2PeriphClockCmd(((uint32_t)0x00040000), ENABLE);
		...
		USART_Init(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), &uart_config_init); 
		
		USART_Cmd(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), ENABLE); 		
    }
    else if (uart_chl == 4)
    {
		RCC_APB2PeriphClockCmd(((uint32_t)0x00080000), ENABLE);
		...
		USART_Init(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00)), &uart_config_init); 
    ...
    else if (uart_chl == 5)
    {
		...
		USART_Init(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000)), &uart_config_init); 
...
static void uart_irq_set(uint8_t uart_chl)
{
	...
	if (uart_chl == 1)
    {
		...
		uart_nvic_config.NVIC_IRQChannelPreemptionPriority 	= 3 ;
		uart_nvic_config.NVIC_IRQChannelSubPriority 		= 3;		
		uart_nvic_config.NVIC_IRQChannelCmd 				= ENABLE;			
		NVIC_Init(&uart_nvic_config);	
...
bool uart_send_byte(uint8_t uart_chl, uint8_t send_byte)
{
	if (uart_chl == 1)
    {
		...
		USART_SendData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), (uint8_t)send_byte);	
    ...
    else if (uart_chl == 2)
    {
		...
		USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), (uint8_t)send_byte);	
    }
    else if (uart_chl == 3)
    {
		while(USART_GetFlagStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), ((uint16_t)0x0040)) == RESET);	

		USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), (uint8_t)send_byte);	
    }
    else if (uart_chl == 4)
    {
		while(USART_GetFlagStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00)), ((uint16_t)0x0040)) == RESET);	

		USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00)), (uint8_t)send_byte);	
    }
    else if (uart_chl == 5)
    {
		while(USART_GetFlagStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000)), ((uint16_t)0x0040)) == RESET);	

		USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000)), (uint8_t)send_byte);	
    }
    else 
    {
        printf("error! \r\n");
...
uint8_t uart_recv_byte(uint8_t uart_chl)
{
	...
	if (uart_chl == 1)
    {
		...
		while((((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->SR & 0X20) == 0);
		recv_byte = ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->DR; 
    ...
    else if (uart_chl == 2)
    {
		...
		recv_byte = USART_ReceiveData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)));	
    }
    else if (uart_chl == 3)
    {
		while (USART_GetFlagStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), ((uint16_t)0x0020)) == RESET);	
		recv_byte = USART_ReceiveData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)));	
    }
    else if (uart_chl == 4)
    {
		while (USART_GetFlagStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00)), ((uint16_t)0x0020)) == RESET);	
		recv_byte = USART_ReceiveData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00)));	
    }
    else if (uart_chl == 5)
    {
		while (USART_GetFlagStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000)), ((uint16_t)0x0020)) == RESET);	
		recv_byte = USART_ReceiveData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000)));	
    }
    else 
    {
        printf("error! \r\n");
