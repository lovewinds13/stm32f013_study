...
bool ee_at24cxx_write_byte(uint16_t write_addr, uint8_t write_byte)
{
    ...
    I2c_SendOneByte(0xA0 | ((write_addr / 256) << 1));    
    if (I2c_WaitAck(200) == 1)
    {
        return 0;
    }
    I2c_SendOneByte(write_addr % 256);	
    if (I2c_WaitAck(200) == 1)
    {
        return 0;
    }

    I2c_SendOneByte(write_byte);    
    if (I2c_WaitAck(200) == 1)
    {
        return 0;
    }
...
bool ee_at24cxx_read_byte(uint16_t read_addr)
{
    ...
    I2c_SendOneByte(0xA0 | ((read_addr / 256) << 1));    
    if (I2c_WaitAck(200) == 1)
    {
        return 0;
    }
    ...
    I2c_SendOneByte(0xA0 | 0x01);  
    if (I2c_WaitAck(200) == 1)
    {
        return 0;
    }

    ret = I2c_RecvOneByte(1);
...
void ee_at24cxx_test(void)
{
	...
	ee_at24cxx_write_some_bytes(0x10, write_buf, sizeof(write_buf));
	Sys_delay_ms(50);
	ee_at24cxx_read_some_bytes(0x10, read_buf, sizeof(write_buf));
