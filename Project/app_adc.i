...
#line 6 "..\\App\\src\\app_adc.c"
#line 7 "..\\App\\src\\app_adc.c"
...
void App_AdcTest(void)
{
	...
	usAdcVal = Get_AdcAverage(((uint8_t)0x01), 10);

	
	
	fTmpVal = (float)usAdcVal * (3.3 / 4096);	
