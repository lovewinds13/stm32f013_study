#line 1 "..\\Driver\\src\\drvexflash.c"
...
#line 49 "..\\Driver\\src\\drvexflash.c"
#line 50 "..\\Driver\\src\\drvexflash.c"
...
#line 51 "..\\Driver\\src\\drvexflash.c"
...
#line 53 "..\\Driver\\src\\drvexflash.c"
...
#line 54 "..\\Driver\\src\\drvexflash.c"
...
#line 55 "..\\Driver\\src\\drvexflash.c"
...
#line 56 "..\\Driver\\src\\drvexflash.c"
...
#line 58 "..\\Driver\\src\\drvexflash.c"
...
void Flash_WriteEnable(void)
{
	...
	hal_spi_send_bytes(1, &command, 1);
...
uint8_t Flash_ReadSR(void)
{
	...
	hal_spi_send_bytes(1, &command, 1);	
	hal_spi_recv_bytes(1, &ucTmpVal, 1);
...
void Flash_WriteSR(uint8_t _ucByte)
{
	...
	(GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), (((uint16_t)0x0004))));
	hal_spi_send_bytes(1, &command, 1);	
	hal_spi_send_bytes(1, &_ucByte, 1);	
	(GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), (((uint16_t)0x0004))));
}
...
void Flash_ReadSomeBytes(uint8_t *ucpBuffer, uint32_t _ulReadAddr, uint16_t _usNByte)
{
	...
	hal_spi_send_bytes(1, &command, 1);
	hal_spi_send_bytes(1, &temp_buff[0], 1);
	hal_spi_send_bytes(1, &temp_buff[1], 1);
	hal_spi_send_bytes(1, &temp_buff[2], 1);

	hal_spi_recv_bytes(1, ucpBuffer, _usNByte);
...
void Flash_WritePage(uint8_t *ucpBuffer, uint32_t _ulWriteAddr, uint16_t _usNByte)
{
	...
	hal_spi_send_bytes(1, ucpBuffer, _usNByte);
...
void Flash_WriteSomeBytes(uint8_t *ucpBuffer, uint32_t _ulWriteAddr, uint16_t _usNByte)
{
	...
	while(1)
	{
		Flash_ReadSomeBytes(g_DataTmpBuffer, ulSecPos*4096, 4096);
		for (i = 0; i < usSecRemain; i++)	
		{
			if (g_DataTmpBuffer[usSecOff + i] != 0xFF)
				break;
		}
		...
		if(i < usSecRemain)	
		{
			...
			for(i = 0; i < usSecRemain; i++)	
			{
				g_DataTmpBuffer[usSecOff + i] = ucpBuffer[i];
			}
			Flash_WriteNoCheck(g_DataTmpBuffer, ulSecPos*4096, 4096);	
		}
		else
		{
...
void Flash_EraseBlock(uint32_t _ulBlockAddr)
{
	...
	(GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), (((uint16_t)0x0004))));
	hal_spi_send_bytes(1, &command, 1);
	hal_spi_send_bytes(1, (uint8_t *)(_ulBlockAddr>>16), 1);
	hal_spi_send_bytes(1, (uint8_t *)(_ulBlockAddr>>8), 1);
	hal_spi_send_bytes(1, (uint8_t *)(_ulBlockAddr>>0), 1);
...
void Flash_EraseChip(void)
{
	...
	(GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), (((uint16_t)0x0004))));
	hal_spi_recv_bytes(1, &command, 1);
...
uint16_t Flash_ReadDeviceID(void)
{
	...
	hal_spi_send_bytes(1, &command, 1);	
	hal_spi_send_bytes(1, temp_buff, 3);	
	hal_spi_recv_bytes(1, temp_buff, 2);
...
uint32_t Flash_ReadJEDECID(void)
{
	...
	hal_spi_send_bytes(1, &command, 1);	
	hal_spi_recv_bytes(1, recv_buff, 3);
...
#line 1137 "..\\Driver\\src\\drvexflash.c"
