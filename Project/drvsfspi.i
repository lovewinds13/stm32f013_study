...
#line 24 "..\\Driver\\src\\drvsfspi.c"
#line 25 "..\\Driver\\src\\drvsfspi.c"
...
void Spi_GpioInit(void)
{
	...
	gpio_init.GPIO_Pin = (((uint16_t)0x0004)) | (((uint16_t)0x0020)) | (((uint16_t)0x0080));	
	gpio_init.GPIO_Speed = GPIO_Speed_2MHz;
	gpio_init.GPIO_Mode = GPIO_Mode_Out_PP;
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), &gpio_init);
	
	gpio_init.GPIO_Pin = (((uint16_t)0x0040));	
	gpio_init.GPIO_Speed = GPIO_Speed_2MHz;
	gpio_init.GPIO_Mode = GPIO_Mode_IN_FLOATING;	
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), &gpio_init);
	

	(GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), (((uint16_t)0x0020))));
...
void Spi_WriteByte(uint8_t _ucByte)
{
    ...
    for (ucDataLen = 0; ucDataLen < 8; ucDataLen++)
    {
        ...
        (GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), (((uint16_t)0x0020))));
...
uint8_t Spi_ReadByte(void)
{
	...
	for(ucDataLen = 0; ucDataLen < 8; ucDataLen++)	
	{
		...
		ucTmpVal <<= 1;	
		if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), (((uint16_t)0x0040))))	
		{
			ucTmpVal |= 0x01;
		}
		else
...
#line 209 "..\\Driver\\src\\drvsfspi.c"
