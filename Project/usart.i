...
#line 2 "..\\Driver\\src\\usart.c"
#line 3 "..\\Driver\\src\\usart.c"
#line 4 "..\\Driver\\src\\usart.c"
...
void Usart_Init(USART_TypeDef *UsartChal, uint32_t bound)
{
	...
	if (UsartChal == ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)))
	{
...
void Usart_SendSomeBytes(USART_TypeDef *UsartChal, uint8_t *pBuffer, uint16_t Len)
{
	...
	for (i = 0; i < Len; i++)
	{
		while(USART_GetFlagStatus(UsartChal, ((uint16_t)0x0040)) == RESET)
		{
