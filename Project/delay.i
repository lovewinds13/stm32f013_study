...
#line 3 "..\\Driver\\src\\delay.c"
#line 4 "..\\Driver\\src\\delay.c"
...
#line 151 "..\\Driver\\src\\delay.c"
	fac_ms = (u16)fac_us*1000;					

}								    

#line 195 "..\\Driver\\src\\delay.c"
...
void Sys_DelayUs(volatile uint32_t _ulDelayTimes)
{
	while (_ulDelayTimes--)
	{
		__nop();
...
void Sys_delay_us(volatile uint32_t _ulTmies)
{
	while (_ulTmies--)
	{
		delay_us(1);
...
void Sys_delay_ms(volatile uint32_t _ulTmies)
{
	while (_ulTmies--)
	{
		delay_ms(1);
