...
#line 5 "..\\App\\src\\app_htu21d.c"
#line 1 "D:\\keil_arm\\ARM\\ARMCC\\Bin\\..\\include\\math.h"
...
#line 61 "D:\\keil_arm\\ARM\\ARMCC\\Bin\\..\\include\\math.h"

#line 75 "D:\\keil_arm\\ARM\\ARMCC\\Bin\\..\\include\\math.h"
...
#line 112 "D:\\keil_arm\\ARM\\ARMCC\\Bin\\..\\include\\math.h"
...
#line 230 "D:\\keil_arm\\ARM\\ARMCC\\Bin\\..\\include\\math.h"
...
#line 251 "D:\\keil_arm\\ARM\\ARMCC\\Bin\\..\\include\\math.h"



extern const int math_errhandling;
#line 261 "D:\\keil_arm\\ARM\\ARMCC\\Bin\\..\\include\\math.h"
...
#line 479 "D:\\keil_arm\\ARM\\ARMCC\\Bin\\..\\include\\math.h"
...
#line 803 "D:\\keil_arm\\ARM\\ARMCC\\Bin\\..\\include\\math.h"
...
#line 856 "D:\\keil_arm\\ARM\\ARMCC\\Bin\\..\\include\\math.h"
...
#line 896 "D:\\keil_arm\\ARM\\ARMCC\\Bin\\..\\include\\math.h"

#line 1087 "D:\\keil_arm\\ARM\\ARMCC\\Bin\\..\\include\\math.h"
...
#line 1317 "D:\\keil_arm\\ARM\\ARMCC\\Bin\\..\\include\\math.h"
...
#line 8 "..\\App\\src\\app_htu21d.c"
#line 1 "..\\Driver\\inc\\drvsfi2c.h"
...
#line 11 "..\\App\\src\\app_htu21d.c"
#line 1 "..\\Driver\\inc\\usart.h"



#line 5 "..\\Driver\\inc\\usart.h"
...
extern void Usart_Init(USART_TypeDef *UsartChal, uint32_t bound);




#line 12 "..\\App\\src\\app_htu21d.c"
...
void Htu_Init(void)
{
	...
	I2c_Init();
	I2c_Start();
	I2c_SendOneByte((0x80 & 0xFE));	
	I2c_WaitAck(200);
	I2c_SendOneByte(0xFe);		
	I2c_WaitAck(200);
	I2c_Stop();
	delay_ms(15);		
}
...
float Htu_Measure(uint8_t _ucOrder)
{
	...
	do{
		...
		I2c_Start();	
		I2c_SendOneByte((0x80 | 0x01));		
	}while(I2c_WaitAck(1)==1);

	ucMsb = I2c_RecvOneByte(0);	
	ucLsb = I2c_RecvOneByte(1);	

	I2c_Stop();

	ucLsb &= 0xFC;		
	fRetVal = ucMsb * 256 + ucLsb; 

	if(_ucOrder == 0xF3)
	{
		fTemp = (175.72) * fRetVal / 65536 - 46.85;

		return fTemp;
	}
	else if(_ucOrder == 0XF5)
	{
		fHumi = (fRetVal * 125) / 65536 - 6;
...
bool htu_read_some_bytes(uint8_t *pbdata, uint16_t read_length)
{
	...
	{
		*pbdata++ = I2c_RecvOneByte(0);
	}
	*pbdata++ = I2c_RecvOneByte(1);	
 ...
 void Htu_Display(void)
{
	...
	f_RetVal = Htu_Measure(0xF3);
	printf("The htu measure temp is :%4.2fC \r\n", f_RetVal);
	
	sprintf((char*)ucTest,"%4.2f", f_RetVal);		
	printf("test is %sC \r\n", ucTest);
	printf("\r\n");
