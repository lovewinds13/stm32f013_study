...
#line 28 "..\\Driver\\src\\drvsfi2c.c"
#line 29 "..\\Driver\\src\\drvsfi2c.c"
...
void I2c_GpioInit(void)
{
	...
	gpio_config_init.GPIO_Pin 	= ((uint16_t)0x1000) | ((uint16_t)0x0800);
...
void I2c_Start(void)
{
	...
	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x1000));						
	I2c_Delay(StI2cInfo.uiI2cSpeed);					
	
	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0800));						
	I2c_Delay(StI2cInfo.uiI2cSpeed);					
	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x1000));	
}
...
uint8_t I2c_RecvOneByte(uint8_t _ucAck)
{
	...
	for(ucCnt = 0; ucCnt < 8; ucCnt++)
	{
		...
		ucData <<= 1;
		if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0800)))
		{
			ucData |= 0x01;
		}
		else
...
#line 297 "..\\Driver\\src\\drvsfi2c.c"
...
uint8_t I2c_WaitAck(uint16_t _usErrTime)
{
	...
	while (GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0800)) && (_usErrTime--))	
	{
		ucAck = 1;	
	}
