...
#line 17 "..\\Driver\\src\\drvadc.c"
#line 18 "..\\Driver\\src\\drvadc.c"
...
{	
	...
	gpio_init.GPIO_Pin = ((uint16_t)0x0002);	
...
uint16_t Get_AdcConvertVal(uint8_t _ucChl)   
{
	...
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), _ucChl, 1, ((uint8_t)0x07));	
